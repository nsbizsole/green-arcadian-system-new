...
import { User, Mail, Phone, Building, MapPin, Save, Lock, Percent } from 'lucide-react';
...
const PartnerProfile = () => {
  ...
  return (
    <div className="space-y-6" data-testid="partner-profile-page">
      <div>
        <h1 className="font-ui text-2xl font-bold text-primary">My Profile</h1>
        <p className="text-primary/60">Manage your partner account settings</p>
      </div>
      ...
      <Card className="bg-accent/10 border-accent/20">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-ui font-bold text-primary">Commission Rate</h3>
              <p className="text-2xl font-bold text-primary">{user?.commission_rate || 10}%</p>
              <p className="text-sm text-primary/60">Your earnings on each approved deal</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-surface/30 border-primary/5">
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              <p className="text-primary/50">Partner Since</p>
              <p className="font-medium text-primary">
                {user?.created_at ? new Date(user.created_at).toLocaleDateString() : 'N/A'}
              </p>
            </div>
            <div>
              <p className="text-primary/50">Commission Rate</p>
              <p className="font-medium text-primary">{user?.commission_rate || 10}%</p>
            </div>
          </div>
        </CardContent>
      </Card>
