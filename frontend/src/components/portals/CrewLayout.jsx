...
import { LayoutDashboard, CheckSquare, ClipboardList, User, LogOut, Menu, Leaf, ChevronRight } from 'lucide-react';
          ...
          <div className="p-4 border-t border-primary/10">
            <div className="flex items-center gap-3 mb-4 p-3 bg-surface/50 rounded-lg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-primary/60">Crew Member</p>
              </div>
            </div>
